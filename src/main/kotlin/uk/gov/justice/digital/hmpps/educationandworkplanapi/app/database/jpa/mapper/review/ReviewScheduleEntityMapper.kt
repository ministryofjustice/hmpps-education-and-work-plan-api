...
class ReviewScheduleEntityMapper {
  ...
  fun fromScheduleHistoryEntityToDomain(reviewScheduleHistoryEntity: ReviewScheduleHistoryEntity): ReviewScheduleHistory = with(reviewScheduleHistoryEntity) {
  ...
  fun fromDomainToEntity(createReviewScheduleDto: CreateReviewScheduleDto): ReviewScheduleEntity = with(createReviewScheduleDto) {
  ...
  fun updateExistingEntityFromDto(entity: ReviewScheduleEntity, dto: UpdateReviewScheduleDto) = with(entity) {
  ...
  private fun toReviewScheduleCalculationRule(calculationRule: ReviewScheduleCalculationRuleEntity): ReviewScheduleCalculationRuleDomain = when (calculationRule) {
    ...
    ReviewScheduleCalculationRuleEntity.PRISONER_TRANSFER_AFTER_FINAL_REVIEW -> ReviewScheduleCalculationRuleDomain.PRISONER_TRANSFER_AFTER_FINAL_REVIEW
  ...
  private fun toReviewScheduleCalculationRule(calculationRule: ReviewScheduleCalculationRuleDomain): ReviewScheduleCalculationRuleEntity = when (calculationRule) {
    ...
    ReviewScheduleCalculationRuleDomain.PRISONER_TRANSFER_AFTER_FINAL_REVIEW -> ReviewScheduleCalculationRuleEntity.PRISONER_TRANSFER_AFTER_FINAL_REVIEW
  ...
  private fun toReviewScheduleStatus(reviewScheduleStatus: ReviewScheduleStatusEntity): ReviewScheduleStatusDomain = when (reviewScheduleStatus) {
    ...
    ReviewScheduleStatusEntity.EXEMPT_PRISONER_RELEASE_HOSPITAL -> ReviewScheduleStatusDomain.EXEMPT_PRISONER_RELEASE_HOSPITAL
  ...
  fun toReviewScheduleStatus(reviewScheduleStatus: ReviewScheduleStatusDomain): ReviewScheduleStatusEntity = when (reviewScheduleStatus) {
    ...
    ReviewScheduleStatusDomain.EXEMPT_PRISONER_RELEASE_HOSPITAL -> ReviewScheduleStatusEntity.EXEMPT_PRISONER_RELEASE_HOSPITAL
