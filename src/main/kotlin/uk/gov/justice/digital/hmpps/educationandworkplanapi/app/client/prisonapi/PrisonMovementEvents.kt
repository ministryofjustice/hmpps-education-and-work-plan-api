...
/**
 * Holds a list Prisoner's movements in or out of Prison, or transfers between Prisons, for each prison Period (AKA
 * "Booking"). The latter can be described as the time spent in Prison for one or more related Sentences. If the
 * Prisoner is released into the community and then subsequently prosecuted for a separate offence later, then this will
 * result in a new Period (i.e. `bookingId`).
 *
