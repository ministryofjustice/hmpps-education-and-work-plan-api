...
class PersonalSkillEntityMapper : KeyAwareEntityMapper<PersonalSkillEntity, PersonalSkill> {
  override fun fromDomainToEntity(domain: PersonalSkill): PersonalSkillEntity = with(domain) {
    PersonalSkillEntity(
      reference = UUID.randomUUID(),
  ...
  override fun updateEntityFromDomain(entity: PersonalSkillEntity, domain: PersonalSkill) = with(entity) {
...
class PersonalInterestEntityMapper : KeyAwareEntityMapper<PersonalInterestEntity, PersonalInterest> {
  override fun fromDomainToEntity(domain: PersonalInterest): PersonalInterestEntity = with(domain) {
  ...
  override fun updateEntityFromDomain(entity: PersonalInterestEntity, domain: PersonalInterest) = with(entity) {
