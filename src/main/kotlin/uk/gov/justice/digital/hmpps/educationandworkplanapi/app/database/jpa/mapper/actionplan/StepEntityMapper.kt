...
class StepEntityMapper : KeyAwareEntityMapper<StepEntity, Step> {
  ...
  fun updateEntityFromDto(stepEntity: StepEntity, updatedStep: UpdateStepDto) =
    with(stepEntity) {
  ...
  override fun updateEntityFromDomain(entity: StepEntity, domain: Step) =
    with(entity) {
      title = domain.title
  ...
  private fun toStepStatus(stepStatus: StepStatusDomain): StepStatusEntity =
    when (stepStatus) {
  ...
  private fun toStepStatus(stepStatus: StepStatusEntity): StepStatusDomain =
    when (stepStatus) {
