...
@Component
class ReviewScheduleHistoryResponseMapper(
  private val instantMapper: InstantMapper,
  private val userService: ManageUserService,
) {

  fun fromDomainToModel(reviewSchedule: ReviewScheduleHistory): ScheduledActionPlanReviewResponse = with(reviewSchedule) {
  ...
  private fun toReviewScheduleStatus(reviewStatus: ReviewScheduleStatusDomain): ReviewScheduleStatusApi = when (reviewStatus) {
  ...
  private fun toReviewScheduleCalculationRule(calculationRule: ReviewScheduleCalculationRuleDomain): ReviewScheduleCalculationRuleApi = when (calculationRule) {
    ...
    ReviewScheduleCalculationRuleDomain.PRISONER_TRANSFER_AFTER_FINAL_REVIEW -> ReviewScheduleCalculationRuleApi.PRISONER_TRANSFER_AFTER_FINAL_REVIEW
