...
class TimelineEventEntityMapper {
  fun fromDomainToEntity(timelineEvent: TimelineEvent): TimelineEventEntity = with(timelineEvent) {
    TimelineEventEntity(
      reference = reference,
  ...
  fun fromEntityToDomain(persisted: TimelineEventEntity): TimelineEvent = with(persisted) {
    TimelineEvent(
      reference = reference,
      sourceReference = sourceReference,
      eventType = toTimelineEventType(eventType),
  ...
  private fun toTimelineEventType(eventType: TimelineEventTypeEntity): TimelineEventTypeDomain = when (eventType) {
