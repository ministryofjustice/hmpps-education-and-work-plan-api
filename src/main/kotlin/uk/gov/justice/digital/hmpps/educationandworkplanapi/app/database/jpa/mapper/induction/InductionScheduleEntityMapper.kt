...
class InductionScheduleEntityMapper {
  ...
  fun fromEntityToDomain(entity: InductionScheduleEntity): InductionSchedule = with(entity) {
    InductionSchedule(
      reference = reference,
  ...
  fun fromScheduleHistoryEntityToDomain(entity: InductionScheduleHistoryEntity): InductionScheduleHistory = with(entity) {
  ...
  fun fromCreateDtoToEntity(createInductionScheduleDto: CreateInductionScheduleDto): InductionScheduleEntity = with(createInductionScheduleDto) {
  ...
  fun toInductionScheduleStatus(inductionScheduleStatus: InductionScheduleStatusDomain): InductionScheduleStatusEntity = when (inductionScheduleStatus) {
