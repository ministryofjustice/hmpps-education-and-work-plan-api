...
@Mapper
interface PreviousWorkExperiencesResourceMapper {
  @Mapping(target = "experiences", source = "request.workExperience")
  fun toCreatePreviousWorkExperiencesDto(request: PreviousWorkRequest?, prisonId: String): CreatePreviousWorkExperiencesDto?
