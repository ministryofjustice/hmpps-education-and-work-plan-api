...
class PreviousWorkExperiencesEntityMapper(
  ...
  fun fromEntityToDomain(persistedEntity: PreviousWorkExperiencesEntity?): PreviousWorkExperiences? = persistedEntity?.let {
  ...
  fun updateExistingEntityFromDto(entity: PreviousWorkExperiencesEntity, dto: UpdatePreviousWorkExperiencesDto) = with(entity) {
  ...
  private fun toHasWorkedBefore(hasWorkedBefore: HasWorkedBeforeDomain): HasWorkedBeforeEntity = when (hasWorkedBefore) {
...
class WorkExperienceEntityMapper : KeyAwareEntityMapper<WorkExperienceEntity, WorkExperience> {
  ...
  fun fromEntityToDomain(persistedEntity: WorkExperienceEntity): WorkExperience = with(persistedEntity) {
    WorkExperience(
      experienceType = toExperienceType(experienceType),
      experienceTypeOther = experienceTypeOther,
      role = role,
  ...
  private fun toExperienceType(experienceType: WorkExperienceTypeEntity): WorkExperienceTypeDomain = when (experienceType) {
  ...
  private fun toExperienceType(experienceType: WorkExperienceTypeDomain): WorkExperienceTypeEntity = when (experienceType) {
