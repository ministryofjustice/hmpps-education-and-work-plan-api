...
data class FutureWorkInterestsEntity(
  @Column(updatable = false)
  val reference: UUID,

  @OneToMany(mappedBy = "parent", cascade = [CascadeType.ALL], orphanRemoval = true, fetch = FetchType.LAZY)
  val interests: MutableList<WorkInterestEntity> = mutableListOf(),
...
data class WorkInterestEntity(
  @Column(updatable = false)
  val reference: UUID,

  @Column
  @Enumerated(value = EnumType.STRING)
  var workType: WorkInterestType,
