...
class JpaInductionPersistenceAdapter(
  ...
  @Transactional(readOnly = true)
  override fun getPreviousQualifications(prisonNumber: String): PreviousQualifications? = previousQualificationsRepository.findByPrisonNumber(prisonNumber)
    ?.let { previousQualificationsMapper.fromEntityToDomain(it) }
}
