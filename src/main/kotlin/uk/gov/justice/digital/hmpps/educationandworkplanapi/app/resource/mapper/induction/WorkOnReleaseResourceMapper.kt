...
class WorkOnReleaseResourceMapper(
  ...
  private fun toAffectAbilityToWork(affectAbilityToWork: AffectAbilityToWorkApi): AffectAbilityToWorkDomain =
  ...
  private fun toAffectAbilityToWork(affectAbilityToWork: AffectAbilityToWorkDomain): AffectAbilityToWorkApi =
    when (affectAbilityToWork) {
  ...
  private fun toHopingToWork(hopingToWork: HopingToWorkApi): HopingToWorkDomain =
    when (hopingToWork) {
  ...
  private fun toHopingToWork(hopingToWork: HopingToWorkDomain): HopingToWorkApi =
    when (hopingToWork) {
