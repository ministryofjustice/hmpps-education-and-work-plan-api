...
class PreviousTrainingResourceMapper(
  ...
  fun toCreatePreviousTrainingDto(request: CreatePreviousTrainingRequest, prisonId: String): CreatePreviousTrainingDto = with(request) {
  ...
  fun toPreviousTrainingResponse(previousTraining: PreviousTraining): PreviousTrainingResponse = with(previousTraining) {
  ...
  fun toUpdatePreviousTrainingDto(request: UpdatePreviousTrainingRequest, prisonId: String): UpdatePreviousTrainingDto = with(request) {
  ...
  private fun toTrainingType(trainingType: TrainingTypeApi): TrainingTypeDomain = when (trainingType) {
  ...
  private fun toTrainingType(trainingType: TrainingTypeDomain): TrainingTypeApi = when (trainingType) {
