...
class FutureWorkInterestsEntityMapper(
  ...
  fun fromEntityToDomain(entity: FutureWorkInterestsEntity?): FutureWorkInterests? =
    entity?.let {
      FutureWorkInterests(
...
class WorkInterestEntityMapper : KeyAwareEntityMapper<WorkInterestEntity, WorkInterest> {
  ...
  override fun updateEntityFromDomain(entity: WorkInterestEntity, domain: WorkInterest) =
    with(entity) {
  ...
  private fun toWorkType(workType: WorkInterestTypeEntity): WorkInterestTypeDomain =
    when (workType) {
  ...
  private fun toWorkType(workType: WorkInterestTypeDomain): WorkInterestTypeEntity =
    when (workType) {
