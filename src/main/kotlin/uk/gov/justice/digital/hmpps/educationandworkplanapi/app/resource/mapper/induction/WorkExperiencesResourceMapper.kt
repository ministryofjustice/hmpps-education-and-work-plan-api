...
class WorkExperiencesResourceMapper(
  ...
  private fun toWorkExperience(experience: PreviousWorkExperience): WorkExperience =
    with(experience) {
      WorkExperience(
        role = role,
        details = details,
  ...
  private fun toPreviousWorkExperience(experience: WorkExperience): PreviousWorkExperience =
    with(experience) {
  ...
  private fun toWorkType(experienceType: WorkExperienceType): WorkType =
    when (experienceType) {
  ...
  private fun toWorkExperienceType(experienceType: WorkType): WorkExperienceType =
    when (experienceType) {
  ...
  private fun toHasWorkedBefore(hasWorkedBefore: HasWorkedBeforeApi): HasWorkedBeforeDomain =
  ...
  private fun toHasWorkedBefore(hasWorkedBefore: HasWorkedBeforeDomain): HasWorkedBeforeApi =
    when (hasWorkedBefore) {
