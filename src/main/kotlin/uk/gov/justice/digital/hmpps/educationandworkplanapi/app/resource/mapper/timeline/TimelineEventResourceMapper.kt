...
class TimelineEventResourceMapper(
  ...
  fun fromDomainToModel(timelineEventDomain: TimelineEvent): TimelineEventResponse = with(timelineEventDomain) {
  ...
  private fun toTimelineEventType(timelineEventType: TimelineEventTypeDomain): TimelineEventTypeApi = when (timelineEventType) {
    ...
    TimelineEventTypeDomain.EMPLOYABILITY_SKILL_CREATED -> TimelineEventTypeApi.EMPLOYABILITY_SKILL_CREATED
