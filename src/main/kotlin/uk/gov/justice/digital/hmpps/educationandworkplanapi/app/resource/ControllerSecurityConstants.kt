...
const val ASSESSMENTS_RO = "ROLE_EDUCATION_AND_WORK_PLAN__ASSESSMENTS__RO"
const val EMPLOYABILITYSKILLS_RO = "ROLE_EDUCATION_AND_WORK_PLAN__EMPLOYABILITYSKILLS__RO"
const val EMPLOYABILITYSKILLS_RW = "ROLE_EDUCATION_AND_WORK_PLAN__EMPLOYABILITYSKILLS__RW"
...
// TODO - remove ACTIONPLANS from these permissions checks once the LWP and Prisoner Profile UI clients are configured with the new EMPLOYABILITYSKILLS in all envs.
const val HAS_VIEW_EMPLOYABILITY_SKILLS = """hasAnyAuthority("$EDITOR", "$VIEWER", "$EMPLOYABILITYSKILLS_RO", "$EMPLOYABILITYSKILLS_RW", "$ACTIONPLANS_RO", "$ACTIONPLANS_RW")"""
const val HAS_EDIT_EMPLOYABILITY_SKILLS = """hasAnyAuthority("$EDITOR", "$EMPLOYABILITYSKILLS_RW", "$ACTIONPLANS_RW")"""
...
const val HAS_VIEW_ASSESSMENTS = """hasAuthority('$ASSESSMENTS_RO')"""
