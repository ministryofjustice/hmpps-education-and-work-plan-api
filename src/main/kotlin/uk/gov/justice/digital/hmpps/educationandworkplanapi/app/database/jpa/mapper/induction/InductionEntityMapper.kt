...
class InductionEntityMapper(
  ...
  fun fromEntitySummariesToDomainSummaries(inductionSummaryProjections: List<InductionSummaryProjection>): List<InductionSummary> =
    inductionSummaryProjections.map {
      InductionSummary(
  ...
  fun updateEntityFromDto(entity: InductionEntity, dto: UpdateInductionDto) =
    with(entity) {
  ...
  private fun updateFutureWorkInterests(entity: InductionEntity, dto: UpdateFutureWorkInterestsDto?) =
    dto?.also {
  ...
  private fun updateInPrisonInterests(entity: InductionEntity, dto: UpdateInPrisonInterestsDto?) =
    dto?.also {
  ...
  private fun updatePersonalSkillsAndInterests(entity: InductionEntity, dto: UpdatePersonalSkillsAndInterestsDto?) =
    dto?.also {
  ...
  private fun updatePreviousTraining(entity: InductionEntity, dto: UpdatePreviousTrainingDto?) =
    dto?.also {
      previousTrainingEntityMapper.updateExistingEntityFromDto(entity.previousTraining, it)
    }

  private fun updatePreviousWorkExperiences(entity: InductionEntity, dto: UpdatePreviousWorkExperiencesDto?) =
    dto?.also {
  ...
  private fun updateWorkOnRelease(entity: InductionEntity, dto: UpdateWorkOnReleaseDto?) =
    dto?.also {
