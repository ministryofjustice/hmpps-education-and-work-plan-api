...
class InPrisonInterestsResourceMapper(
  ...
  private fun toPrisonTrainingInterest(inPrisonTrainingInterest: InPrisonTrainingInterest): InPrisonTrainingInterestDomain =
    with(inPrisonTrainingInterest) {
  ...
  private fun toPrisonWorkInterest(inPrisonWorkInterest: InPrisonWorkInterest): InPrisonWorkInterestDomain =
    with(inPrisonWorkInterest) {
  ...
  private fun toInPrisonTrainingType(inPrisonTrainingType: InPrisonTrainingType): InPrisonTrainingTypeDomain =
    when (inPrisonTrainingType) {
  ...
  private fun toInPrisonWorkType(inPrisonWorkType: InPrisonWorkType): InPrisonWorkTypeDomain =
    when (inPrisonWorkType) {
  ...
  private fun toPrisonTrainingInterest(inPrisonTrainingInterestDomain: InPrisonTrainingInterestDomain): InPrisonTrainingInterest =
    with(inPrisonTrainingInterestDomain) {
  ...
  private fun toPrisonWorkInterest(inPrisonWorkInterestDomain: InPrisonWorkInterestDomain): InPrisonWorkInterest =
    with(inPrisonWorkInterestDomain) {
  ...
  private fun toInPrisonTrainingTypeDomain(inPrisonTrainingTypeDomain: InPrisonTrainingTypeDomain): InPrisonTrainingType =
    when (inPrisonTrainingTypeDomain) {
  ...
  private fun toInPrisonWorkTypeDomain(inPrisonWorkTypeDomain: InPrisonWorkTypeDomain): InPrisonWorkType =
    when (inPrisonWorkTypeDomain) {
