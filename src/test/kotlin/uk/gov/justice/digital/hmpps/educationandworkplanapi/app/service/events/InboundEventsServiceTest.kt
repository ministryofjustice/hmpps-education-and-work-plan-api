...
internal class InboundEventsServiceTest {
  ...
  fun `should fail to process unrecognised event`() {
    ...
    // Then
    assertThat(TestLogAppender.hasLog("Unsupported event uk.gov.justice.digital.hmpps.educationandworkplanapi.app.service.events.UnrecognisedInboundEvent", Level.WARN)).isTrue
  }
}
