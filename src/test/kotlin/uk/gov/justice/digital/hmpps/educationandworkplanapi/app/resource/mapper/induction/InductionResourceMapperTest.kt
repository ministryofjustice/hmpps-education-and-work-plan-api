...
class InductionResourceMapperTest {
  ...
  @Mock
  private lateinit var employabilitySkillsResourceMapper: EmployabilitySkillsResourceMapper
  ...
  fun `should map to InductionResponse`() {
    ...
    val expectedInduction = aFullyPopulatedInductionResponse(
      ...
      conductedBy = induction.conductedBy,
      conductedByJobRole = induction.conductedByRole,
      completedAt = induction.completedDate,
      notes = induction.note?.content,
