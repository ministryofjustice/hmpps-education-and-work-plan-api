...
fun aValidUpdateWorkOnReleaseRequest(): UpdateWorkOnReleaseRequest = aValidUpdateWorkOnReleaseRequestForPrisonerNotLookingToWork()
...
): UpdateWorkOnReleaseRequest = UpdateWorkOnReleaseRequest(
  reference = reference,
