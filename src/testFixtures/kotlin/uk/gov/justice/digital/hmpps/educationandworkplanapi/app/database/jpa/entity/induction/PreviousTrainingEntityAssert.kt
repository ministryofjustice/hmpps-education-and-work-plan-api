...
fun assertThat(actual: PreviousTrainingEntity?) = PreviousTrainingEntityAssert(actual)

/**
 * AssertJ custom assertion for [PreviousTrainingEntity]
 */
class PreviousTrainingEntityAssert(actual: PreviousTrainingEntity?) :
  AbstractObjectAssert<PreviousTrainingEntityAssert, PreviousTrainingEntity?>(
    actual,
  ...
  fun doesNotHaveJpaManagedFieldsPopulated(): PreviousTrainingEntityAssert {
    isNotNull
    with(actual!!) {
      if (id != null || createdAt != null || createdBy != null || updatedAt != null || updatedBy != null) {
  ...
  fun hasId(expected: UUID): PreviousTrainingEntityAssert {
    isNotNull
    with(actual!!) {
      if (id != expected) {
  ...
  fun wasCreatedBy(expected: String): PreviousTrainingEntityAssert {
    isNotNull
    with(actual!!) {
  ...
  fun wasCreatedAt(expected: Instant): PreviousTrainingEntityAssert {
    isNotNull
    with(actual!!) {
  ...
  fun wasUpdatedBy(expected: String): PreviousTrainingEntityAssert {
    isNotNull
    with(actual!!) {
  ...
  fun wasUpdatedAt(expected: Instant): PreviousTrainingEntityAssert {
    isNotNull
    with(actual!!) {
