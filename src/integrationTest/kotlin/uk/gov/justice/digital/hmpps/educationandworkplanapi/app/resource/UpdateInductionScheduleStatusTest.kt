...
class UpdateInductionScheduleStatusTest : IntegrationTestBase() {
  ...
  @Test
  fun `should not add 5 days to latest induction date when exemption removed given the induction was already overdue when the exemption was applied`() {
    // Given
    createInductionSchedule(
      prisonNumber,
      status = InductionScheduleStatusEntity.EXEMPT_PRISONER_FAILED_TO_ENGAGE,
  ...
  @Test
  fun `should not add 10 days to latest induction date when exclusion removed given the induction was already overdue when the exclusion was applied`() {
    // Given
    createInductionSchedule(
      prisonNumber,
      status = InductionScheduleStatusEntity.EXEMPT_PRISON_REGIME_CIRCUMSTANCES,
