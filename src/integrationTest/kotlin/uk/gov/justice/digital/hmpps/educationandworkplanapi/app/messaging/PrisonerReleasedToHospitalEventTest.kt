...
@Isolated
class PrisonerReleasedToHospitalEventTest : IntegrationTestBase() {
  @Test
  fun `should update Review Schedule given released prisoner has an active Review Schedule`() {
    ...
    val sqsMessage = aValidHmppsDomainEventsSqsMessage(
      ...
      additionalInformation = aValidPrisonerReleasedAdditionalInformation(
        ...
        reason = AdditionalInformation.PrisonerReleasedAdditionalInformation.Reason.RELEASED_TO_HOSPITAL,
      ),
    )
    ...
    assertThat(actionPlanReviews)
      .latestReviewSchedule {
        it.hasStatus(ReviewScheduleStatus.EXEMPT_PRISONER_RELEASE_HOSPITAL)
      }
  }
  ...
  fun `should update Induction Schedule given released prisoner has an active Induction Schedule`() {
    ...
    await.untilAsserted {
      ...
      assertThat(inductionSchedule)
        .wasStatus(InductionScheduleStatus.EXEMPT_PRISONER_RELEASE_HOSPITAL)
    }
  }
